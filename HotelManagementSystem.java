...
{
    Doubleroom luxury_doublerrom[]=new Doubleroom[10]; //Luxury room
    Doubleroom deluxe_doublerrom[]=new Doubleroom[20]; //Deluxe room
    Singleroom luxury_singleerrom[]=new Singleroom[10]; //Luxury room
    Singleroom deluxe_singleerrom[]=new Singleroom[20]; //Deluxe room
}
...
class Hotel
{
    ...
    static void CostDetails(int i, int rn)
    {
